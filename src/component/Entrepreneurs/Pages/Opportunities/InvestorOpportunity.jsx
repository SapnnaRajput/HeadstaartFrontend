      ...
      <div className="p-6">
        ...
        {investor.length === 0 ? (
          <div className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">No Investors Available</h2>
            <p className="text-gray-500 max-w-md">
              There are currently no investors in the system. Check back later for new investors.
            </p>
          </div>
        ) : (
              ...
              <div className="p-4 flex flex-col flex-grow">
                <div className="flex-grow">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-medium text-gray-800 line-clamp-1 capitalize">{item.client_name}</span>
                  </div>
                  <p className="text-sm text-gray-500 mb-1 line-clamp-1">{item.title}</p>
                  <p className="text-sm text-gray-500 line-clamp-1">{item.category?.category_name}</p>
                </div>
                <button
                  onClick={() => 
                    navigate(`/entrepreneur/investor-opportunities/${item.chat_initiate_id}/${item.client_unique_id}/${item.project_unique_id}`)
            ...
            {modalLoading ? (
              ...
              <div className="flex flex-col">
                ...
                <div className="mb-6">
                  ...
                  <Link to={`/entrepreneur/projects/${clientData?.project_unique_id}`} target='_blank'>

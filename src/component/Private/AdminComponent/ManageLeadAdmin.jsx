...
import { formatDate } from './UserDetail';

const ManageLeadAdmin = () => {
    ...
    useEffect(() => {
        ...
        const updatePaymentStatus = async () => {
          try {
            const response = await axios.post(`${baseUrl}/manage_lead_admin`,
              {
                customer_unique_id 
              },
              {
                                ...
                                >
                                    <div className="flex items-center gap-6">
                                        ...
                                        <div className='space-y-1'>
                                            ...
                                            <p className="text-sm text-gray-500">Lead Buy Date <span className='bg-blue-300 p-1 rounded text-blue-600 font-medium'>
                                                {' '}{formatDate(purchase?.lead_buy_date)}
                                                </span></p>
...
export default ManageLeadAdmin;
...
function SignIn() {
  ...
  const handleNextButtonClick = () => {
    navigate(`/sign-up?type=${selectedOption}`)
  }
        ...
        <div className="flex shadow-2xl rounded-3xl overflow-hidden bg-white w-full max-w-4xl">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12">
            <div className="w-full max-w-md">
              ...
              <h2 className="text-3xl font-bold text-gray-800 mb-2">Sign Up As</h2>
              ...
              <p className="text-center text-gray-600 mt-6">
                ...
                <Link to="/login-as" className="text-blue-600 font-semibold hover:underline">
                  Login
                </Link>
              </p>
            </div>
